...
class CategoryMapping extends AbstractMapping{
    ...
    protected ?string $article_name=null; 
    ...
    public function setArticleText(?string $category_desc): void
    {
