...
<p>Cette classe ne contient qu'une propriété , on peut tout de même l'instancier en utilisant le mot clef <strong>new</strong>, c'est-à-dire créer une instance de la classe (donc un objet)</p>
...
?>
<p>Une valeur vide pour une propriété non typée donne <strong>null</strong></p>
<h3>Les propriétés publiques</h3>
<p>Elles peuvent être lues et réécrites depuis n'importe ou (dans la classes, dans ses héritiers, depuis l'extérieur de la classe)</p>
...
// $lulu n'existe pas, les anciennes versions le crée, à éviter car dangereux cela ne sera plus permis (sans __set(), mais reste rare).
// sera obselète en PHP 9.0
// $user1->lulu = 5;
...
<p>Sans typage, aucune sécurité (sauf à partir de PHP8.1 avec readonly)</p>
<?php
